            ...
            if CheckVar10.get() == 1:
                ...
                for item in REcurrentlist:
                    ...
                    while index2 < len(gtc):
                        ...
                        if index4 < 0:
                            break
                        sheet.write(row, column, (index4 + REcurrentlist[index3][2])-(index2 + REcurrentlist[index3][2]))
                        index2 += 6
                        row += 1
                    sheet.write(row, column, len(gtc)-(gtc.rfind(REcurrentlist[index3][1]) + REcurrentlist[index3][2]))
                    row += 1
                    index3 += 1
                    column += 1
                row = 0
